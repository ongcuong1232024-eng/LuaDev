...
local Player = game.Players.LocalPlayer --This Will Reveal The Player Name
  local Window = OrionLib:MakeWindow({
		Name = "LuaDevvn.github.io",
		HidePremium = false,
		SaveConfig = true,
		ConfigFolder = "Welcome",
...
getgenv().Key = "grw076eiwy7" --chỗ cần thay
getgenv().KeyInput = "string" --chỗ cần thay
...
Tab:AddButton({
    ...
    loadstring(game:HttpGet("https://your-script-link.lua"))()
end)